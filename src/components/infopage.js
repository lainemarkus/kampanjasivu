        ...
        <div id="background" className="flex-container">
            ...
            <div id="sailio" className="grid-container">
                ...
                <div id="item1" className="grid-item small2" data-aos="fade-left" >
                    ...
                    <p>Koronarokotteen kohdalla rokotteiden tutkimus, kehitys ja luvat on saatu tehtyä nopeasti vastaamaan kiirellistä tarvetta, kuitenkin noudattaen korkeita turvallisuusstrandardeja. Kehitystä on nopeuttanut muun muassa tieteellinen yhteistyö, riittävä rahoitus sekä vapaaehtoisten riittävä määrä. Myös aiempien koronavirustautien (SARS ja MERS) tutkimuksista kertynyttä tietoa ja rokotekehitystä on käytetty apuna Covid-19 rokotteiden kehittämisessä. [2] </p>
                </div>
                ...
                <div className="grid-item large2" data-aos="fade-up" data-aos-delay="200" data-aos-duration="500">
                    ...
                    <p><span className="white bold"><li>Voit seurata Lääkealan turvallisuus- ja keittämiskeskuksen, Fimean, ylläpitämää listaa koronarokotteiden haittavaikutusilmoituksista Suomessa <a target="_blank" rel="noopener noreferrer" href="https://www.fimea.fi/tietoa_fimeasta/koronavirus-covid-19-/koronarokotteiden-haittavaikutusilmoitukset">täältä </a></li></span></p>
                </div>
